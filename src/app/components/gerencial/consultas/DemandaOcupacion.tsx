...
const ocupacionSemanalData = [
  ...
  { dia: "Mi茅", ocupacion: 72, capacidad: 100 },
  { dia: "Jue", ocupacion: 68, capacidad: 100 },
  { dia: "Vie", ocupacion: 85, capacidad: 100 },
  { dia: "S谩b", ocupacion: 92, capacidad: 100 },
...
const porHorarioData = [
  ...
  { name: "Ma帽ana (06-12)", value: 35, color: "#4b5563" },
...
export function DemandaOcupacion() {
  return (
    <div className="min-h-full bg-background">
      <PageHeader
        title="Demanda y Ocupaci贸n"
        subtitle="An谩lisis de utilizaci贸n de capacidad"
        actions={
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-4 gap-6">
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            ...
            <p className="text-sm text-muted-foreground">Ocupaci贸n Promedio</p>
          </div>
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            ...
            <p className="text-sm text-muted-foreground">Ocupaci贸n M谩xima (S谩b)</p>
          </div>
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            ...
            <p className="text-sm text-muted-foreground">Ocupaci贸n M铆nima (Mar)</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            <h3 className="font-semibold text-foreground mb-4">Ocupaci贸n Semanal</h3>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={ocupacionSemanalData}>
                ...
                />
                <Legend />
                <Bar dataKey="ocupacion" fill="var(--foreground)" radius={[8, 8, 0, 0]} name="Ocupaci贸n %" />
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            <h3 className="font-semibold text-foreground mb-4">Distribuci贸n por Horario</h3>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={porHorarioData}
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="bg-card rounded-xl p-6 border border-border">
            ...
            <p className="text-sm text-muted-foreground">
              Los fines de semana presentan ocupaci贸n del 90%. Considere agregar m谩s servicios.
            </p>
          </div>
          ...
          <div className="bg-card rounded-xl p-6 border border-border">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="font-semibold text-foreground">Optimizaci贸n</h4>
            </div>
            <p className="text-sm text-muted-foreground">
              Martes y mi茅rcoles tienen baja ocupaci贸n. Eval煤e reducir frecuencias.
            </p>
          </div>
          ...
          <div className="bg-card rounded-xl p-6 border border-border">
            ...
            <p className="text-sm text-muted-foreground">
              El 35% de la demanda se concentra en horarios de ma帽ana (06-12).
            </p>
          </div>
        </div>
      </div>
