    ...
    <div className="min-h-full bg-background">
        ...
        actions={
          <div className="flex items-center gap-3">
            <select className="px-4 py-2 border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ring bg-background text-foreground">
              ...
              <option>脷ltimos 3 meses</option>
              <option>脷ltimos 6 meses</option>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            <h3 className="font-semibold text-foreground mb-4">Evoluci贸n de Ingresos y Utilidad</h3>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            <h3 className="font-semibold text-foreground mb-4">M茅todos de Pago</h3>
