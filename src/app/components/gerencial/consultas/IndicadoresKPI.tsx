...
const radarData = [
  { categoria: "Satisfacci贸n", valor: 94, fullMark: 100 },
  { categoria: "Puntualidad", valor: 96, fullMark: 100 },
  { categoria: "Ocupaci贸n", valor: 78, fullMark: 100 },
  ...
  return (
    <div className="min-h-full bg-background">
      <PageHeader
        ...
        subtitle="M茅tricas clave de desempe帽o empresarial"
        actions={
      ...
      <div className="p-8 space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-4 gap-6">
            <KPICard title="Ocupaci贸n Promedio" value="78%" change={5.2} icon={Users} variant="secondary" />
        ...
        <div>
          ...
          <div className="grid grid-cols-4 gap-6">
            <KPICard title="Satisfacci贸n Cliente" value="4.7/5" change={4.2} icon={Star} variant="secondary" />
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
            <h3 className="mb-4 font-semibold text-foreground">Evoluci贸n de KPIs Principales</h3>
          ...
          <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
            <h3 className="mb-4 font-semibold text-foreground">Radar de Desempe帽o</h3>
            <ResponsiveContainer width="100%" height={300}>
        ...
        {/* Performance Summary */}
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
          <h3 className="mb-4 font-semibold text-foreground">Resumen de Desempe帽o</h3>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-emerald-700">鉁?105%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-foreground">Ocupaci贸n</span>
                  <span className="text-sm font-bold text-emerald-700">鉁?98%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-foreground">Satisfacci贸n</span>
                  <span className="text-sm font-bold text-emerald-700">鉁?112%</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-amber-600">鈿?96%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-foreground">Eficiencia</span>
                  <span className="text-sm font-bold text-amber-600">鈿?88%</span>
                </div>
              </div>
            </div>

            <div className="space-y-3">
              <h4 className="text-sm font-medium text-muted-foreground">脥ndice Global</h4>
              <div className="flex items-center gap-4">
                <div className="flex-1">
                  <div className="text-4xl font-bold text-foreground">87.5</div>
                  <p className="mt-1 text-sm text-muted-foreground">Puntuaci贸n General</p>
                </div>
