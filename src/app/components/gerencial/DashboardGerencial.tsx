  ...
  return (
    <div className="min-h-full bg-background">
      <PageHeader
        ...
        subtitle="Visi贸n general del desempe帽o empresarial"
      />
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">脷ltimos 6 meses</p>
              </div>
          ...
          <div className="bg-card rounded-xl shadow-sm border border-border p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="font-semibold text-foreground">Ocupaci贸n de Flota</h3>
              ...
              <div className="ml-8 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">78% (39 veh铆culos)</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">22% (11 veh铆culos)</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="font-semibold text-foreground">Rutas m谩s Rentables</h3>
